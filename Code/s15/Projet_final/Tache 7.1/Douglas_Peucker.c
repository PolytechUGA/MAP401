...
Liste_Point algo_Douglas_Peucker(Tableau_Point C, int j1, int j2, double d){
    double dmax, dj;
    int k;
...
Liste_Bezier3 simplification_douglas_peucker_bezier2(Tableau_Point CONT, int j1, int j2, double d){
    ...
    if (dmax<=d){
        // A noter que avant d'être ajouter à la liste chainée de Bézier 3,
        // la courbe est convertie en courbe de degré 3 car le format EPS
        // ne prend en charge que des courbes de Bézier de degré 3.
