...
do
    ...
    elif [ $lecture_tache -eq 8 ]
    then
        echo -e "${jaune} Vous avez demander la Tâche 8 : ${neutre}"
        echo -e "${jaune} La Tâche 8.1 renvoie le temps d'execution de la simplification par segment d'une image pbm avec d=0${neutre}"
        echo -e "${jaune} La Tâche 8.2 fait la simplification par segment, bézier2 et bézier3 d'une image pbm selon les distances 0 0.5 1 2 4 8 16${neutre}" 
        echo -e "${rouge} Voulez-vous la Tâche 8.1 ou 8.2 (Envoyez 1 ou 2 par SMS au 72500 vous avez 5 min pour jouer ;) )${neutre} "
        read numero_tache
        while [ ${numero_tache} -ne 1 -a ${numero_tache} -ne 2 ]
        do
            echo -e "${jaune} Le numéro de tâche que vous avez entré est inccorect.${neutre}"
            echo -e "${rouge} Entrez un nouveau numéro de tâche (1 Pour 8.1 et 2 pour 8.2)${neutre} "
            read numero_tache
        done

        if [ ${numero_tache} -eq 1 ]
        then 
            echo -e "${jaune} Test de la Tâche8.1 : "
            echo -e " Exemple avec le fichier zebres-1000x0750.pbm : "
            echo -e " Sortie: Tache8.1_deux-des-pleins_d1_m0.EPS  Distance : 0 Mode : 1 (Remplissage)${neutre} "
            # Exécution de l'exemple zebres-1000x0750.pbm en mode Remplissage avec distance de 0
            echo time ./simplification_par_segment ${ch_T_8}zebres-1000x0750.pbm 0 1 ${ch_T_8_S}Tache8.1_zebres-1000x0750_d0_m1.EPS
            time ./simplification_par_segment ${ch_T_8}zebres-1000x0750.pbm 0 1 ${ch_T_8_S}Tache8.1_zebres-1000x0750_d0_m1.EPS
            ...
            while [ $lecture_new_image = $OUI ]
            do
                echo -e "${rouge} Entrez le nom de l'image (dans le dossier ${ch_T_8}):${neutre} "
                read name_image
                echo -e "${rouge} Entrez le nom du fichier de sortie.EPS (dans le dossier ${ch_T_8_S}):${neutre} "
                read name_f_out
                echo -e "${rouge} Entrez le mode (0=Contour ou 1=Remplissage):${neutre} "
                read mode
                echo time ./simplification_par_segment ${ch_T_8}${name_image} 0 ${mode} ${ch_T_8_S}Tache8.1_${name_f_out}
                time ./simplification_par_segment ${ch_T_8}${name_image} ${distance} ${mode} ${ch_T_8_S}Tache8.1_${name_f_out}
            ...
            echo -e "${jaune} Test de la Tâche8.2 : "
            echo -e " Exemple avec le fichier Asterix3.pbm : "
            echo -e " Sortie: Tache8.2_Asterix3_d(distance)_m1_seg.EPS  Distance : 1 Mode : 0 (Contours)${neutre} "
            # Exécution de l'exemple deux-des-pleins.pbm en mode Concours avec distance de 1
            for d in 0 0.5 1 2 4 8 16
            do
                echo -e " ${rouge}./simplification_par_segment ${ch_T_8_2}Asterix3.pbm ${d} 1 ${ch_T_8_S}Tache8.2_Asterix3_d${d}_m1_seg.EPS ${neutre}"
                ./simplification_par_segment ${ch_T_8_2}Asterix3.pbm ${d} 1 ${ch_T_8_S}Tache8.2_Asterix3_d${d}_m1_seg.EPS
                echo -e " ${rouge}./simplification_par_bezier2 ${ch_T_8_2}Asterix3.pbm ${d} 1 ${ch_T_8_S}Tache8.2_Asterix3_d${d}_m1_seg.EPS ${neutre}"
                ./simplification_par_bezier2 ${ch_T_8_2}Asterix3.pbm ${d} 1 ${ch_T_8_S}Tache8.2_Asterix3_d${d}_m1_bez2.EPS
                echo -e " ${rouge}./simplification_par_bezier3 ${ch_T_8_2}Asterix3.pbm ${d} 1 ${ch_T_8_S}Tache8.2_Asterix3_d${d}_m1_seg.EPS ${neutre}"
                ./simplification_par_bezier3 ${ch_T_8_2}Asterix3.pbm ${d} 1 ${ch_T_8_S}Tache8.2_Asterix3_d${d}_m1_bez3.EPS
            done
            ...
            while [ $lecture_new_image = $OUI ]
            do
                echo -e "${rouge} Entrez le nom de l'image (dans le dossier ${ch_T_8_2}):${neutre} "
                read name_image
                echo -e "${rouge} Entrez le nom du fichier de sortie.EPS (dans le dossier ${ch_T_8_S}):${neutre} "
                read name_f_out
                echo -e "${rouge} Entrez le mode (0=Contour ou 1=Remplissage):${neutre} "
                ...
                for d in 0 0.5 1 2 4 8 16
                do
                    echo -e " ${rouge}./simplification_par_segment ${ch_T_8_2}${name_image} ${d} ${mode} ${ch_T_8_S}Tache8.2_${name_f_out} ${neutre}"
                    ./simplification_par_segment ${ch_T_8_2}${name_image} ${d} ${mode} ${ch_T_8_S}Tache8.2_${name_f_out}
                    echo -e " ${rouge}./simplification_par_bezier2 ${ch_T_8_2}${name_image} ${d} ${mode} ${ch_T_8_S}Tache8.2_${name_f_out}_d${d}_m${mode}_bez2.EPS ${neutre}"
                    ./simplification_par_bezier2 ${ch_T_8_2}${name_image} ${d} ${mode} ${ch_T_8_S}Tache8.2_${name_f_out}_d${d}_m${mode}_bez2.EPS
                    echo -e " ${rouge}./simplification_par_bezier3 ${ch_T_8_2}${name_image} ${d} ${mode} ${ch_T_8_S}Tache8.2_${name_f_out}_d${d}_m${mode}_bez3.EPS ${neutre}"
                    ./simplification_par_bezier3 ${ch_T_8_2}${name_image} ${d} ${mode} ${ch_T_8_S}Tache8.2_${name_f_out}_d${d}_m${mode}_bez3.EPS
                done
                echo -e "${rouge} Voulez-vous essayer sur une autre image ? (O/N)${neutre} "
                read lecture_new_image
            done
