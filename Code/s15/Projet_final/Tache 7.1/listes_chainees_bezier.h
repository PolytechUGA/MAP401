...
// Supprime tout les éléments d'une liste chainée de courbe de bézier de degré 3 et la renvoie.
Liste_Bezier3 supprimer_liste_Bezier3(Liste_Bezier3 L);

// Concatene les deux listes chainées données en argument et renvoie le résultat.
Liste_Bezier3 concatener_liste_Bezier3(Liste_Bezier3 L1, Liste_Bezier3 L2);

// Renvoie le nombre de courbe de bezier de degre 3 stockée dans la liste.
